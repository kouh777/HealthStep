 ...
 */
public class char_Shouta extends CharacterBase {
    ...
    public char_Shouta(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharacterID = menu_Character.CHAR_SHOUTA_ID;

        m_CharResource.addElement( (BitmapDrawable)gv.getResources().getDrawable(R.drawable.char203_shouta1) );
        // if anim_flg == false , don't load those image files
        if(anim_flg) {
            m_CharResource.addElement((BitmapDrawable) gv.getResources().getDrawable(R.drawable.char203_shouta4));
            m_CharResource.addElement((BitmapDrawable) gv.getResources().getDrawable(R.drawable.char203_shouta2));
            m_CharResource.addElement((BitmapDrawable) gv.getResources().getDrawable(R.drawable.char203_syouta3));
        }
