 ...
 */
public class char_Shouta implements CharacterBase {
    ...
    public char_Shouta(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char203_shouta1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char203_shouta2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char203_syouta3);
    ...
    public int characterID(){
        return menu_Character.CHAR_SHOUTA_ID;
    }
}
