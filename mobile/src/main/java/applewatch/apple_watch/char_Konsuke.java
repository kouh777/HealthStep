 ...
 */
public class char_Konsuke implements CharacterBase {
    ...
    public char_Konsuke(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource = new BitmapDrawable[2];
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char300_konsuke1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char300_konsuke2);
    ...
    public int characterID(){
        return menu_Character.CHAR_KONSUKE_ID;
    }
}
