 ...
 */
public class char_Syu implements CharacterBase {
    ...
    public char_Syu(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char202_syu1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char202_syu2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char202_syu3);
    ...
    public int characterID(){
        return menu_Character.CHAR_SYU_ID;
    }
}
