 ...
 */
public class char_Banjyo implements CharacterBase {
    ...
    public char_Banjyo(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char204_banjyo1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char204_banjyo4);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char204_banjyo2);
        m_CharResource[3] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char204_banjyo3);
    ...
    public int characterID(){
        return menu_Character.CHAR_BANJYO_ID;
    }
}
