 ...
 */
public class btn_Gacha implements Buttons {
    ...
    public btn_Gacha(GameView gv, int posX, int posY){
        m_GameView = gv;
        m_iPosX = posX;
        m_iPosY = posY;
        m_iNextSceneID = m_GameView.m_SceneGacha;

        // load image resources
        m_btn_Resource = (BitmapDrawable)gv.getResources().getDrawable(R.drawable.button_gatya);
