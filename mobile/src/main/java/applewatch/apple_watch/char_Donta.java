 ...
 */
public class char_Donta implements CharacterBase {
    ...
    public char_Donta(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char301_donta1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char301_donta2);
    ...
    public int characterID(){
        return menu_Character.CHAR_DONTA_ID;
    }
}
