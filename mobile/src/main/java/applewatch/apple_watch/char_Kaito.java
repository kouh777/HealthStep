 ...
 */
public class char_Kaito implements CharacterBase {
    ...
    public char_Kaito(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char201_kaito1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char201_kaito2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char201_kaito3);
    ...
    public int characterID(){
        return menu_Character.CHAR_KAITO_ID;
    }
}
