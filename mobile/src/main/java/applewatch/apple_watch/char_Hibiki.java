 ...
 */
public class char_Hibiki implements  CharacterBase {
    ...
    public char_Hibiki(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char205_hibiki1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char205_hibiki2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char205_hibiki3);
    ...
    public int characterID(){
        return menu_Character.CHAR_HIBIKI_ID;
    }
