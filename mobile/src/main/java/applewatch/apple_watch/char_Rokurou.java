 ...
 */
public class char_Rokurou implements CharacterBase {
    ...
    public char_Rokurou(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char207_rokuro1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char207_rokuro2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char207_rokuro3);
    ...
    public int characterID(){
        return menu_Character.CHAR_ROKUROU_ID;
    }
}
