 ...
 */
public class char_Ryu implements CharacterBase {
    ...
    public char_Ryu(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char303_ryu1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char303_ryu2);
    ...
    public int characterID(){
        return menu_Character.CHAR_RYU_ID;
    }
}
