 ...
 */
public class char_Unknown implements CharacterBase{
    ...
    public char_Unknown(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource = new BitmapDrawable[1];
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char_unknown);
...
//          doAnim();
    ...
    public int characterID(){
        return menu_Character.CHAR_UNKNOWN_ID;
    }
}
