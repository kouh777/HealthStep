 ...
 */
public class char_Unknown extends CharacterBase{
    ...
    public char_Unknown(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharacterID = menu_Character.CHAR_UNKNOWN_ID;

        m_CharResource.addElement( (BitmapDrawable)gv.getResources().getDrawable(R.drawable.unknown_waku) );
