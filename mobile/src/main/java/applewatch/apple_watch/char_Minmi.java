 ...
 */
public class char_Minmi implements CharacterBase {
    ...
    public char_Minmi(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char302_minmi1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char302_minmi2);
    ...
    public int characterID(){
        return menu_Character.CHAR_MINMI_ID;
    }
}
