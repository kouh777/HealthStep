 ...
 */
public class char_Nekoko implements CharacterBase {
    ...
    public char_Nekoko(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char103_nekoko1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char103_nekoko2);
    ...
    public int characterID(){
        return menu_Character.CHAR_NEKOKO_ID;
    }
