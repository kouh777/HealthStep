 ...
 */
public class char_Momoka implements CharacterBase {
    ...
    public char_Momoka(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char105_momoka1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char105_momoka2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char105_momoka3);
    ...
    public int characterID(){
        return menu_Character.CHAR_MOMOKA_ID;
    }
}
