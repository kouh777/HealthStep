 ...
 */
public class char_Urara implements CharacterBase {
    ...
    public char_Urara(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char101_urara1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char101_urara2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char101_urara3);
    ...
    public int characterID(){
        return menu_Character.CHAR_URARA_ID;
    }
