...
public class btn_Gallery implements Button{
    ...
    public btn_Gallery(GameView gv, int posX, int posY){
        m_GameView = gv;
        m_iPosX = posX;
        m_iPosY = posY;
        m_iNextSceneID = m_GameView.m_SceneGallery;

        // load image resources
        m_btn_Resource = (BitmapDrawable)gv.getResources().getDrawable(R.drawable.button_gallery);
