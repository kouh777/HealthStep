 ...
 */
public class char_Miki implements CharacterBase {
    ...
    public char_Miki(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char104_miki1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char104_miki2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char104_miki3);
    ...
    public int characterID(){
        return menu_Character.CHAR_MIKI_ID;
    }
}
