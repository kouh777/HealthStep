 ...
 */
public class char_Sizuku extends CharacterBase {
    ...
    public char_Sizuku(GameView gv, int posX, int posY, float scale, boolean anim_flg) {
        ...
        m_CharacterID = menu_Character.CHAR_SIZUKU_ID;

        m_CharResource.addElement( (BitmapDrawable)gv.getResources().getDrawable(R.drawable.char102_shizuku1) );
        // if anim_flg == false , don't load those image files
        if(anim_flg) {
            m_CharResource.addElement((BitmapDrawable) gv.getResources().getDrawable(R.drawable.char102_shizuku4));
            m_CharResource.addElement((BitmapDrawable) gv.getResources().getDrawable(R.drawable.char102_shizuku2));
            m_CharResource.addElement((BitmapDrawable) gv.getResources().getDrawable(R.drawable.char102_sizuku3));
        }
