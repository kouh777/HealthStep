 ...
 */
public class char_Sizuku implements CharacterBase {
    ...
    public char_Sizuku(GameView gv, int posX, int posY, float scale, boolean anim_flg) {
        ...
        m_CharResource[0] = (BitmapDrawable) gv.getResources().getDrawable(R.drawable.char102_shizuku1);
        m_CharResource[1] = (BitmapDrawable) gv.getResources().getDrawable(R.drawable.char102_shizuku2);
        m_CharResource[2] = (BitmapDrawable) gv.getResources().getDrawable(R.drawable.char102_sizuku3);
    ...
    public int characterID() {
        return menu_Character.CHAR_SIZUKU_ID;
    }
