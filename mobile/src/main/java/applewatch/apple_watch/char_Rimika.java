 ...
 */
public class char_Rimika implements CharacterBase{
    ...
    public char_Rimika(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char106_rimika1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char106_rimika2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char106_rimika3);
    ...
    public int characterID(){
        return menu_Character.CHAR_RIMIKA_ID;
    }
}
