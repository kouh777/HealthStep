 ...
 */
public class char_Rin implements CharacterBase{
    ...
    public char_Rin(GameView gv, int posX, int posY, float scale, boolean anim_flg){
        ...
        m_CharResource[0] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char107_rin1);
        m_CharResource[1] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char107_rin2);
        m_CharResource[2] =(BitmapDrawable)gv.getResources().getDrawable(R.drawable.char107_rin3);
    ...
    public int characterID(){
        return menu_Character.CHAR_RIN_ID;
    }
}
